...
- `{ }`: is mainly used for `Scoops , IF Else Statments and Switch and object {key : value}`
- `( )`: is mainly used for `variable`
...
```js
// 1. printing string
consol.log("Hello World"); // -> Hello World
...
The structure of object is a pair of `key:vaule`
